...
<div id="nav">
    <div class="nav-left inlineBlock">
        <div class="personalImage">
            <img src="${pageContext.request.contextPath}/images/chart/2.png" alt=""/>
        </div>
        <a href="#">如翼</a>
...
<%--<script type="text/javascript" src="/js/echarts.js" language="javascript"></script>--%>
<%--<script type="text/javascript" src="/js/infographic.js" language="javascript"></script>--%>
<%--<script type="text/javascript" src="/js/classie.js" language="javascript"></script>--%>
